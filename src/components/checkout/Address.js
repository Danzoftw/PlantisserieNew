...
const Address = ({input, countries, states, handleOnChange, isFetchingStates, isShipping}) => {
    ...
    return (
        <>
            <div className="email-outer checkout-border p-4">
                <InputField
                    name="email"
                    type="email"
            ...
            <div className="mt-4 p-4 customer-info d-flex justify-content-between checkout-border">
                <h2 className="text-xl font-medium font-hk font-weight-600 theme color-covid-color mb-0">Shipping Info</h2>
                <p className="font-hk font-weight-400 mb-0">*Required</p>
            </div>
            <div className="shipping-container checkout-border p-4">
                <div className="flex flex-wrap overflow-hidden sm:-mx-3">
                    <InputField
                        ...
                        errors={errors}
                        isShipping={isShipping}
                        containerClassNames="w-full overflow-hidden sm:px-3 md:w-1/2"
                ...
                <InputField
                    ...
                    containerClassNames="mt-3"
                />
                <div className="ssz flex flex-wrap overflow-hidden my-3 sm:-mx-3">
                    <InputField
                        name="city"
                        required
                        ...
                        errors={errors}
                        isShipping={isShipping}
                        containerClassNames="font-hk font-weight-400 w-full overflow-hidden sm:px-3 md:w-1/3"
                    />
                    <InputField
                        name="state"
                        required
                    ...
                    <InputField
                        ...
                        errors={errors}
                        isShipping={isShipping}
                        containerClassNames="font-hk font-weight-400 w-full overflow-hidden sm:px-2 md:w-1/3"
                    />
                </div>
                {/* <InputField
                    name="company"
                ...
                {/* <InputField
                        ...
                        handleOnChange={handleOnChange}
                        isShipping={isShipping}
                        containerClassNames="font-hk font-weight-400 w-full overflow-hidden sm:my-4 sm:px-3 md:w-1/2"
                    /> */}
                {/* State */}
                {/* <StateSelection
                    input={input}
