...
const CartItemsContainer = () => {
	...
	return (
		<div className="cart product-cart-container container mx-auto my-32 px-4 xl:px-0">
			{ cart ? (
				<div className="pt-5 woo-next-cart-wrapper container">
					<div className="cart-header grid grid-cols-2 gap-4">
						<h1 className="text-2xl mb-5 uppercase font-hk">Cart</h1>
						{/*Clear entire cart*/}
						<div className="clear-cart text-right">
							<button className="theme bg-color-1 px-4 py-1 bg-gray-500 text-white rounded-sm w-auto" onClick={ ( event ) => handleClearCart( event ) } disabled={ clearCartProcessing }>
								<span className="woo-next-cart font-hk font-weight-600">Clear Cart</span>
					...
					<div className="grid grid-cols-1 xl:grid-cols-4 gap-0 xl:gap-4 mb-5">
						<table className="cart-products table-auto col-span-3 mb-5">
								...
								<tr className="woo-next-cart-head-container">
									...
									<th className="woo-next-cart-heading-el" scope="col"/>
									<th className="woo-next-cart-heading-el font-hk" scope="col">Product</th>
									<th className="woo-next-cart-heading-el font-hk" scope="col">Price</th>
									<th className="woo-next-cart-heading-el font-hk" scope="col">Quantity</th>
									<th className="woo-next-cart-heading-el font-hk" scope="col">Total</th>
								</tr>
								</thead>
								<tbody>
						...
						{/*Cart Total*/ }
						<div className="row woo-next-cart-total-container justify-content-center checkout-border">
							<div className="">
								{/* <h2 className="text-2xl">Cart Total</h2> */}
								<table className="table mb-5">
									<tbody>
										<tr className="table-light flex flex-col">
											<td className="woo-next-cart-element-total text-2xl font-hk">Subtotal</td>
											<td className="woo-next-cart-element-amt text-2xl font-hk">{ ( 'string' !== typeof cart.totalProductsPrice ) ? cart.totalProductsPrice.toFixed(2) : cart.totalProductsPrice }</td>
										</tr>
								...
								<Link href="/checkout">
									<button className="theme bg-color-2 text-white px-5 py-3 rounded-sm w-auto xl:w-full">
										<span className="woo-next-cart-checkout-txt font-hk font-weight-600">Proceed to Checkout</span>
